...
public class AccountController {
    ...
    // Creating new accounts (savings or checking)
    ...
    public AccountController(SavingsAccountService savingsAccountService,
                             ...
                             UserService userService, ExRateService exRateService) {
    ...
    public String createSavingsAccount(@AuthenticationPrincipal UserDetails userDetails,
    ...
    public String createCheckingAccount(@AuthenticationPrincipal UserDetails userDetails,
                                        @RequestParam("clientNumber") String clientNumber,
                                        Model model) {
        User user = userService.findByUsername(userDetails.getUsername());
    ...
    public String userAccounts(@AuthenticationPrincipal UserDetails userDetails, Model model) {
    ...
    public String requestNewProduct(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        User user = userService.findByUsername(userDetails.getUsername());
    ...
    public String getCheckingInfo(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        String username = userDetails.getUsername();
    ...
    public String getSavingInfo(@AuthenticationPrincipal UserDetails userDetails, Model model) {
        String username = userDetails.getUsername();
